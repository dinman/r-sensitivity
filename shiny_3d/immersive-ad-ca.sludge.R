...
load("../shiny_scratch/sampled_design.ca.sludge.ratereturn.31may.fixpng.RDA")
load("../shiny_scratch/sampled_results.ca.sludge.ratereturn.31may.fixpng.RDA")
...
ui <- {
  ...
  fluidPage(
    ...
    titlePanel("Local Sensitivity Analysis of CA Sludge Using Mood"),
